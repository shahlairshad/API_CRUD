...
class HomeScreencrud extends StatefulWidget {
  const HomeScreencrud({super.key});

  @override
  State<HomeScreencrud> createState() => _HomeScreencrudState();
}

class _HomeScreencrudState extends State<HomeScreencrud> {
  ...
  fetchData() async {
    await Provider.of<
        HomeScreenController>(context, listen: false).getData();
  }
